      ...
      <div className="about-review">
        ...
        <div className="full-review">
          <div className="my-jop card flex2">
            <h2> My Jop</h2>
            <p>
              I’m a front-end developer with 3+ years of experience in creating
              responsive, user-friendly websites. I love clean design and
        ...
        <div className="all-projects">
          <div className="first-project">
            ...
            <div className="btn-container2 flex2">
              <Link to="/portfolio-project" className="btn2">
                VIEW
              </Link>
            </div>
          </div>
