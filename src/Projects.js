    ...
    <>
      <div className="projects-page-section">
        <div className="projects-intro card flex2">
          <h2> My Projects</h2>
          <p>
            Here are some of my favorite projects. Each one shows my passion for
        ...
        <div className="best-projects">
          ...
          <div className="best-projects-container">
            <div className="portofoglio">
              ...
              <div className="button-container1 flex">
            ...
            <div className="e-shop-lite">
              ...
              <p>Discription:</p>
              <p>
                A simple online store front-end template for small businesses.
                It showcases products, allows filtering by category, and
                includes a basic cart UI (without real checkout).
              </p>
              <div className="button-container2 flex">
                <button className="btn2">SOURCE CODE</button>
                <button className="btn2">LIVE DEMO</button>
              </div>
            </div>
        ...
        <div className="contact-container card">
          ...
          <Link className="btn-other-pages" to="/contact">
            CONTACT ME
          </Link>
        </div>
      </div>
